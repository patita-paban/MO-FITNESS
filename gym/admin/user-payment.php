              ...
              <div class="span5">
                <table class="">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td><h4>MO-FITNESS</h4></td>
                    </tr>
                    <tr>
                      <td>UNIT 8,BHUBANESWAR</td>
                    </tr>
                    ...
                    <tr>
                      <td >Email: MO-FITNESS@gmail.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table class="table table-bordered table-invoice">
				  ...
				  <form action="userpay.php" method="POST">
                    ...
                    <tr>
                      ...
                      <td><input id="amount" type="number" name="amount" value='<?php if($row['services'] == 'Fitness') { echo '1000';} elseif ($row['services'] == 'Sauna') { echo '35';} else {echo '40';} ?>' /></td>
                    </tr>

...
<div id="header">
  <h1><a href="dashboard.html">MO-FITNESS Gym Admin</a></h1>
</div>
<!--close-Header-part--> 
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered data-table table-hover'>
            ...
            <tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=<?php echo $row['user_id']?>'><button class='btn btn-success btn'></i> Make Payment</button></a></div></td>
